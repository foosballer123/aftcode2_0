...
rosbag record /camera/color/image_raw /omega_d /ball_pos /motor1_pos -O ~/catkin_ws/src/aftcode2_0/rosbags/st1_p120_h6_bBR_LV_DL_$(date +"%y_%m_%d_%H_%M_%S") &
