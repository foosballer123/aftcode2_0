...
python3 ~/catkin_ws/src/aftcode2_0/scripts/mov_agent.py --desired_pos=20
echo "Moved."
...
rosbag record /camera/color/image_raw /omega_d /ball_pos /motor1_pos -O ~/catkin_ws/src/aftcode2_0/rosbags/experiment_1_$(date +%s) &
