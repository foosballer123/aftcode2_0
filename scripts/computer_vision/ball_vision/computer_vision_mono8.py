...
mono_img = np.zeros((720, 1280, 1), dtype = "uint8")
...
def get_image(ros_img):
    ...
    mono_img = CvBridge().imgmsg_to_cv2(ros_img, "mono8")
    # raise flag
    img_received = True
...
if __name__ == '__main__':
    ...
    img_sub = rospy.Subscriber("/pylon_camera_node/image_raw", Image, get_image)
